  ...
  return (
    <div className="my-[40px] lg:my-[80px]">
      <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8  rounded-3xl max-w-6xl mx-auto  mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-richblack-800 before:h-full max-md:before:hidden">
        <div>
          <h2 className="text-gray-800 text-3xl font-extrabold font-poppins">
            Get In Touch
          </h2>
          <p className="text-sm text-gray-500 mt-4 leading-relaxed font-roboto">
          ...
          <ul className="mt-4 flex flex-wrap justify-center gap-6">
            <li className="flex items-center text-white">
              ...
              <a href="javascript:void(0)" className="text-sm ml-4">
                <strong>petpathway8@example.com</strong>
              </a>
            </li>
        ...
        <div className="z-10 relative h-full max-md:min-h-[350px]">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.942006287798!2d77.11392890959324!3d28.631500175563744!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d0351baff6933%3A0x48a94e3504dadb9e!2sGuru%20Tegh%20Bahadur%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1731783117438!5m2!1sen!2sin"
